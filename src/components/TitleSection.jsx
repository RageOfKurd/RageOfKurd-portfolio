...
const TitleSection = () => {
  return (
    <section className='flex flex-col gap-2 sm:gap-3 lg:gap-5 justify-center items-center mt-8 lg:mt-12'>
        <h1 className='text-3xl sm:text-4xl lg:text-5xl  font-bold text-center text-neutral-500'>Hello, I am <span className='font-bold text-neutral-700'>Hevar</span></h1>
